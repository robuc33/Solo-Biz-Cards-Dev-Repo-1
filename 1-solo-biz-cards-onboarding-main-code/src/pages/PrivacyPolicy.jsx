          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex">
                ...
                <Link
                  to="/privacy-policy"
                  className="flex items-center text-gray-900 font-medium text-sm leading-5 pt-1 pl-1 pr-1 border-b-[1.6px] border-blue-500 no-underline ml-4 sm:ml-8"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <Link
                  to="/terms-of-service"
                  className="flex items-center text-gray-500 font-medium text-sm leading-5 pt-1 pl-1 pr-1 border-b-[1.6px] border-transparent no-underline ml-4 sm:ml-8"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <section>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      when using our digital business card service:
                    </p>
                    <ul className="list-disc ml-6 mt-2 text-sm text-gray-600 space-y-1">
                      ...
                      <li>Profile photos and other images you upload</li>
                    </ul>
                  </section>
                  {/* Section 2 */}
                  <section>
                    ...
                    <ul className="list-disc ml-6 mt-2 text-sm text-gray-600 space-y-1">
                      <li>
                        Creating and maintaining your digital business card
                      </li>
